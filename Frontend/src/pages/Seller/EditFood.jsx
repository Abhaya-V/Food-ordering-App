  ...
  return (
    <div className="container mt-5 d-flex justify-content-center">
      <div className="card p-4 shadow" style={{ maxWidth: "600px", width: "100%", borderRadius: "20px" }}>
        <h3 className="text-center mb-4 text-center">Edit Food Item</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <div className="d-flex">
              <select className="form-select me-2" name="category" value={form.category} onChange={handleChange} required>
